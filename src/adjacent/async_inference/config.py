...
class AsyncConfig:
    ...
    endpoint_reinforcement_threshold: int = 2  # Only reinforce if anchors_seen count < this value
    endpoint_reinforcement_max_confidence: float = 0.70  # Don't reinforce if confidence >= this
